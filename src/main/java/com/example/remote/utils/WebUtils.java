...
public class WebUtils {
    ...
    public static String getJsonStrFromPostUrl(String url,
        ...
        return getJsonStrFromPostUrl(url, paramList, null);
    }
    ...
    public static String getJsonFromPostUrl(String url,
        ...
        return getJsonStrFromPostUrl(url, paramList,headers);
    }
    ...
    public static String getJsonStrFromPostUrl(String url,
                                               List<NameValuePair> params, Map<String,String> headers) {
        return getJsonStrFromPostUrlWithContentType(url, params, ContentType.APPLICATION_JSON, headers);
    }



    public static String getJsonStrFromPostUrlWithContentType(String url,
                                                              List<NameValuePair> params, ContentType contentType, Map<String,String> headers) {
        try {
            ...
            LOG.info("params: "+ JSONArray.fromObject(params));
    ...
    public static String getJsonFromPostUrlAsForm(String url,
        ...
        return getJsonStrFromPostUrlWithContentType(url, paramList, ContentType.APPLICATION_FORM_URLENCODED, null);
    }
...
//                    LOG.info("status error:"+ statusCode + entity);
    ...
    public static String getJsonStrFromGetUrl(String url, Map<String,String> headers) {
        try {
            CloseableHttpClient client = HttpClients.createDefault();
            HttpGet get = new HttpGet(url);
            get.addHeader("Content-Type", "application/json");
    ...
    private static RequestConfig createRequestConfig() {
        RequestConfig config = RequestConfig.custom().setSocketTimeout(400000)
